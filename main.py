...
def createGraph(dfdbc: cantools.database.can.database.Database):
    ...
    net.add_node("CAN_Network", label="CAN Network", level=0, color="#862633", 
                title="Root node of CAN bus messages", size=25)
    ...
    for message in dfdbc.messages:
        ...
        for signal in message.signals:
            ...
            choices_str = format_choices(signal.choices if hasattr(signal, 'choices') else None)
            info = f"""
